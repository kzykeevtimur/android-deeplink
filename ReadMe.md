...
### Общие правила
Deeplink ссылки формируются по следующим правилам:
- Структура: `[доменный_префикс]/[тип_пользователя]/[объект]?[key1=value]&[key2=value]...`,
  где:
    ...
    - параметры:
        ...
        - filter - фильтр по заданиям в проекте
            ...
            - finished - фильтр показывает только завершенные задания
